...
class interp1d(object):
    def __init__(self, a, b, h, f, k=3, p=0, c=True, e=0):
        """
        ...
        if p is False, f is assumed to be given on:
            [a, b]
        For periodic interpolation (p = 1 or 2)
    ...
    for mi in numba.prange(m):
        ...
        for i in range(2):
            ...
            if ixi >= n:
                ...
                ixip = ixi
            # ixip = 2 * n - ixi - 1  if ixi >= n else ixi
            ixi = [ixi, ixi % n, ixip][p]
            fout[mi] += f[ixi] * asx[i]
...
class interp2d(object):
    def __init__(self, a, b, h, f, k=3, p=[0] * 2, c=[True] * 2, e=[0] * 2):
        """
    ...
    for mi in numba.prange(m):
        ...
        for i in range(2):
            ...
            for j in range(2):
                ...
                fout[mi] += f[ixip, iyjp] * asx[i] * asy[j]
...
class interp3d(object):
    def __init__(self, a, b, h, f, k=3, p=[0] * 3, c=[True] * 3, e=[0] * 3):
        """
        See the documentation for interp1d
        this function is the same, except that a, b, h, p, c, and e
        ...
        for i in range(2):
            ...
            for j in range(2):
                ...
                for k in range(2):
                    ...
                    fout[mi] += f[ixip, iyjp, izk] * asx[i] * asy[j] * asz[k]
